...
export const SITE_TITLE =
  process.env.NEXT_PUBLIC_SITE_TITLE || 'Sigen Gallery (alpha)';
...
export const HAS_DEFINED_SITE_DESCRIPTION = Boolean(
...
// STORAGE: VERCEL BLOB
export const HAS_VERCEL_BLOB_STORAGE = Boolean(
...
export const AI_TEXT_GENERATION_ENABLED = Boolean(
...
export const HIGH_DENSITY_GRID =
  GRID_ASPECT_RATIO <= 1 && !PREFERS_LOW_DENSITY_GRID;
...
export const CONFIG_CHECKLIST_STATUS = {
  ...
  aiTextAutoGeneratedFields: process.env.AI_TEXT_AUTO_GENERATED_FIELDS
    ...
    : ['all'],
  hasAiTextAutoGeneratedFields: Boolean(
    process.env.AI_TEXT_AUTO_GENERATED_FIELDS,
  ),
  ...
  hasGridDensityPreference: Boolean(
    process.env.NEXT_PUBLIC_SHOW_LARGE_THUMBNAILS,
  ),
  baseUrl: BASE_URL,

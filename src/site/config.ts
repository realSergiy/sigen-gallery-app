...
export const SITE_TITLE = process.env.NEXT_PUBLIC_SITE_TITLE || 'Sigen Gallery (alpha)';

// SOURCE
export const VERCEL_COMMIT_MESSAGE = process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_MESSAGE;
export const VERCEL_COMMIT_SHA = process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA;
...
export const HAS_DEFINED_SITE_DESCRIPTION = Boolean(process.env.NEXT_PUBLIC_SITE_DESCRIPTION);
...
// STORAGE: VERCEL KV
export const HAS_VERCEL_KV = Boolean(process.env.KV_URL);
...
export const GRID_HOMEPAGE_ENABLED = process.env.NEXT_PUBLIC_FEED_HOMEPAGE === '0';
export const STATICALLY_OPTIMIZED_PAGES = process.env.NEXT_PUBLIC_STATICALLY_OPTIMIZE_PAGES === '1';
...
export const GENERATE_RESIZED_IMAGE = process.env.GENERATE_RESIZED_IMAGE === '1';
...
export const CONFIG_CHECKLIST_STATUS = {
  ...
  isStaticallyOptimized: STATICALLY_OPTIMIZED_PAGES || STATICALLY_OPTIMIZED_OG_IMAGES,

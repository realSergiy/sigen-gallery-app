...
export default function SiteChecklistClient({
  ...
  const renderSubStatus = (
    ...
    <div className="flex translate-x-[-3px] gap-2">
  ...
  const renderWarning = ({
    ...
    <WarningNote className="mb-3 mt-2">
      {connection && (
        <>
          {connection.provider} connection error: {`"${connection.error}"`}
        </>
    ...
    <div className="w-full max-w-xl">
      <div className="space-y-6">
        <Checklist title="Storage" icon={<BiData size={16} />}>
          <ChecklistRow
            title={
              hasDatabase && isTestingConnections
          ...
          >
            ...
            {hasDatabase &&
              ...
              renderSubStatus(
                'checked',
                <>
                  Postgres-compatible: connected (SSL{' '}
                  {isPostgresSslEnabled ? 'enabled' : 'disabled'})
                </>,
              )}
          </ChecklistRow>
          <ChecklistRow
        ...
        <Checklist title="Authentication" icon={<BiLockAlt size={16} />}>
          <ChecklistRow
            title={
              !hasAuthSecret && isTestingConnections
                ? 'Generating secret'
                : 'Setup auth'
            }
            ...
            {!hasAuthSecret && (
              <div className="overflow-x-auto">
                <Container className="my-1.5 inline-flex" padding="tight">
                  <div
                    className={clsx(
                      '-mx-1 flex flex-nowrap items-center gap-2 leading-none',
                    )}
                  >
        ...
        <Checklist title="Content" icon={<BiPencil size={16} />}>
          <ChecklistRow title="Configure domain" status={hasDomain} showWarning>
            {!hasDomain &&
              renderWarning({
                message:
        ...
        {!simplifiedView && (
          <>
            ...
            >
              <ChecklistRow
                title={
                  isAiTextGenerationEnabled && isTestingConnections
              ...
              >
                ...
                Store your OpenAI secret key in order to add experimental
                support for AI-generated text descriptions and enable an
                invisible field called {'"Semantic Description"'} used to
                support CMD-K search:
                {renderEnvVars(['OPENAI_SECRET_KEY'])}
              </ChecklistRow>
              <ChecklistRow
                title={
                  hasVercelKv && isTestingConnections
              ...
              <ChecklistRow
                ...
                optional
              >
                Comma-separated fields to auto-generate when uploading photos.
                Accepted values: title, caption, tags, description, all, or none
                (default is {'"all"'}):
            ...
            <Checklist title="Settings" icon={<BiCog size={16} />} optional>
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"1"'} to show grid layout on
                homepage:
              ...
              <ChecklistRow
                ...
                optional
              >
                {"Set environment variable to 'light' or 'dark'"} to configure
              ...
              <ChecklistRow title="Pro mode" status={isProModeEnabled} optional>
                Set environment variable to {'"1"'} to enable higher quality
                image storage:
              ...
              <ChecklistRow
                ...
                experimental
              >
                Set environment variable to {'"1"'} to enable static
              ...
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"1"'} to constrain the size of
                each photo, and enable a surrounding border:
                {renderEnvVars(['NEXT_PUBLIC_MATTE_PHOTOS'])}
              </ChecklistRow>
              <ChecklistRow title="Image blur" status={isBlurEnabled} optional>
                Set environment variable to {'"1"'} to prevent image blur data
              ...
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"1"'} to enable public photo
                downloads for all visitors:
              ...
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"1"'} to enable a public API
                available at <code>/api</code>:
              ...
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"1"'} to prevent priority order
                photo field affecting photo order:
                {renderEnvVars(['NEXT_PUBLIC_IGNORE_PRIORITY_ORDER'])}
              </ChecklistRow>
              <ChecklistRow title="Show social" status={showSocial} optional>
                Set environment variable to {'"1"'} to hide X button from share
                modal:
              ...
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"1"'} to prevent simulations
                showing up in /grid sidebar and CMD-K results:
              ...
              <ChecklistRow
                ...
                optional
              >
                Set environment variable to {'"BOTTOM"'} to keep OG image text
      ...
      <div className="mt-4 pl-11 pr-2 sm:pr-11 md:mt-7">
        <div>
        ...
        {!simplifiedView && (
          <div className="text-dim before:content-['—']">
            <div className="flex whitespace-nowrap">
              ...
              &nbsp;&nbsp;
              <span className="flex w-full overflow-x-auto">
                {baseUrl || 'Not Defined'}
              </span>
            </div>
            <div>

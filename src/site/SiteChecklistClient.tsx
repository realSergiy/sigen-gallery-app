...
export default function SiteChecklistClient({
  ...
  const renderCopyButton = (label: string, text?: string, subtle?: boolean) => (
    <LoaderButton
      icon={<BiCopy size={15} />}
      className={clsx('translate-y-[2px]', subtle && 'text-gray-300 dark:text-gray-700')}
      onClick={
        text
          ? () => {
    ...
    <div className="w-full max-w-xl">
      <div className="space-y-6">
        <Checklist title="Storage" icon={<BiData size={16} />}>
          <ChecklistRow
            title={
              hasDatabase && isTestingConnections ? 'Testing database connection' : 'Setup database'
            }
            status={hasDatabase}
        ...
        <Checklist title="Authentication" icon={<BiLockAlt size={16} />}>
          <ChecklistRow
            title={!hasAuthSecret && isTestingConnections ? 'Generating secret' : 'Setup auth'}
            ...
            {!hasAuthSecret && (
              <div className="overflow-x-auto">
                <Container className="my-1.5 inline-flex" padding="tight">
                  <div className={clsx('-mx-1 flex flex-nowrap items-center gap-2 leading-none')}>
          ...
          <>
            ...
            <Checklist title="Settings" icon={<BiCog size={16} />} optional>
              ...
              <ChecklistRow
                ...
                experimental
              >
                Set environment variable to {'"1"'} to enable static optimization, i.e., rendering
        ...
        {!simplifiedView && (
          <div className="text-dim before:content-['—']">
            <div className="flex whitespace-nowrap">
              ...
              &nbsp;&nbsp;
              <span className="flex w-full overflow-x-auto">{baseUrl || 'Not Defined'}</span>
            </div>
            <div>
              <span className="font-bold">Commit</span>
              &nbsp;&nbsp;
              {commitSha ? <span title={commitMessage}>{commitSha}</span> : 'Not Found'}
            </div>
          </div>
        )}
      </div>

...
export const parseAiAutoGeneratedFieldsText = (text = 'all'): AiAutoGeneratedField[] => {
  ...
  if (textFormatted === 'none') {
    ...
    const fields = textFormatted
      ...
      .filter(field => ALL_AI_AUTO_GENERATED_FIELDS.includes(field as AiAutoGeneratedField));
...
export const AI_IMAGE_QUERIES: Record<AiImageQuery, string> = {
  ...
  'title-and-caption':
    'Write a compelling title and pithy caption of 8 words or less for this image, using the format Title: "title" Caption: "caption"',
  tags: 'Describe this image three or less comma-separated keywords with no adjective or adverbs',
  'description-small':
    'Describe this image succinctly without the initial text "This image shows" or "This is a picture of"',
  description: 'Describe this image',
  'description-large': 'Describe this image in detail',
  'description-semantic':
    'List up to 5 things in this image without description as a comma-separated list',
};

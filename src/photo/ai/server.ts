...
import { AI_IMAGE_QUERIES, AiAutoGeneratedField, parseTitleAndCaption } from '.';
import { getMessage, toErrorWithMessage } from '@/utility/err';
...
export const generateAiImageQueries = async (
  ...
  try {
    ...
    console.log('Error generating AI image text', msg);
  }
